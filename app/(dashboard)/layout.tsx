...
import {
    ...
    Database,
    Menu,
    MessageSquare, // NEW: Added for Chat
    ShieldCheck    // NEW: Added for Teams & Access
} from "lucide-react";
...
export default function DashboardLayout({
    ...
    // UPDATED: Added Chat and Teams & Access to the menu
    const navigation = [
        ...
        { name: "Teams & Access", href: "/teams", icon: ShieldCheck },
